...
<html>
    <head>
        <title>Chatt Dental Group - Login Error</title>
        <meta charset="UTF-8" />
    ...
    <body>
        ...
        <div>
            <p>The appointment slot was either taken or invalid data was entered. Please click the back button and try again.</p>
        </div>
        <footer>
